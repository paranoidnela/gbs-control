...
VRST_VALUE=$(( (($(i2cget -y 0 0x17 0x03) & 0x7f) << 4) + ($(i2cget -y 0 0x17 0x02) >> 4) ))
TOP_VALUE=$(( ( (($(i2cget -y 0 0x17 0x08) & 0x07) << 8) + $(i2cget -y 0 0x17 0x07) -1) ))
BOTTOM_VALUE=$(( ( (($(i2cget -y 0 0x17 0x09) & 0x7f) << 4) + ($(i2cget -y 0 0x17 0x08) >> 4) -1) ))
...
i2cset -r -y -m 0x7f 0 0x17 0x09 $((BOTTOM_VALUE >> 4))
i2cset -r -y -m 0xf0 0 0x17 0x08 $(( (BOTTOM_VALUE & 0x00F) << 4))

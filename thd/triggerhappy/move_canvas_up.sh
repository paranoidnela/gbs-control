...
sed -i 776c\\$LOW /home/$USER/settings/defaults/current.set
sed -i 777c\\$MED /home/$USER/settings/defaults/current.set
sed -i 778c\\$HIGH /home/$USER/settings/defaults/current.set
# Register adjust
